...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_n,      spawn,          SHCMD("$TERMINAL -e notes ranger") },
	{ MODKEY|ControlMask|Mod1Mask,  XK_n,      spawn,          SHCMD("$TERMINAL -e notes find") },
	{ MODKEY|ControlMask,           XK_n,      spawn,          SHCMD("$TERMINAL -e notes journal") },
	{ MODKEY,                       XK_o,      spawn,          SHCMD("chromium --profile-directory=\"Default\" --new-window https://docs.google.com/spreadsheets/d/14uu321lifzWad1456NsA6FgS8febTf64zDtL2nu29Is/") },
...
static Button buttons[] = {
	...
	{ ClkRootWin,           0,              Button3,        spawn,          SHCMD("nitrogen") },
