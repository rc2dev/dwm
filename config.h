...
static Key keys[] = {
	...
	{ MODKEY,                       XK_o,      spawn,          SHCMD("x-www-browser --new-window 'https://www.fatsecret.com.br/Diary.aspx?pa=fj'") },
	{ MODKEY|ShiftMask,             XK_o,      spawn,          SHCMD("$TERMINAL -e notes journal") },
